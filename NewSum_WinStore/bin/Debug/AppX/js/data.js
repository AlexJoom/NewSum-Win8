(function () {
    ...
    NewSum.FetchOlderArticles = function (categoryName, loadingCallBack, FinishedCallback) {
        ...
        if (NewSum.groups[categoryName].fetchedData == undefined) {
            ...
            //https://api.mongolab.com/api/1/databases/newsum/collections/articles?apiKey=bD52OMB9YRbyUoRgbwIgv94zMD1BOTco&q={"CategoryName":"{0}","milliseconds":{$lt:{1}}}&s={"milliseconds":-1}&l=100
            var getOldestUrl = "https://api.mongolab.com/api/1/databases/newsum/collections/articles?apiKey=bD52OMB9YRbyUoRgbwIgv94zMD1BOTco&q={\"CategoryName\":\"{0}\",\"milliseconds\":{$lt:{1}}}}&s={\"milliseconds\":-1}&l=100".replace("{0}", encodeURIComponent(categoryName)).replace("{1}", oldestArticleFound.milliseconds);
